...
from arxiv_curator.paper import ArxivArticle
...
def fetch_arxiv_papers(query: str = "cat:cs.AI OR cat:cs.LG", max_results: int = 100):
    ...
    for result in client.results(search):
        paper = ArxivArticle.from_arxiv_result(result)
        papers.append(paper.to_dict())  # Convert Pydantic model to dict for DataFrame creation
