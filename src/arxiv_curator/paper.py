...
class ArxivArticle(BaseModel):
    ...
    primary_category: str = Field(
        ...,
        description="The primary arXiv category"
    )
    ...
    processed: bool | None = Field(None, description="Processing status flag (set in Lecture 2.2)")
    volume_path: str | None = Field(None, description="Path to volume storage (set in Lecture 2.2)")
    model_config = {
